        ...
        return (
            <View style={{ height: '100%', width: '100%', backgroundColor: 'white' }}>
                ...
                <View style={{ backgroundColor: 'white', alignItems: 'center', width: '100%', height: '20%', justifyContent: 'center' }}>
                    <Text style={{ fontSize: 30, fontWeight: 'bold', textAlign: 'center', }}>Rando Store</Text>
                </View>
                <View style={{ height: '40%', backgroundColor: 'white' }}>
                    <TouchableOpacity style={{ backgroundColor: "#2196F3", width: '70%', height: '25%', marginLeft: '15%', marginRight: '15%', marginTop: '5%', borderRadius: 40, justifyContent: 'center', }}
